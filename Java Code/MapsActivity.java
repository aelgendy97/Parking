...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
    ...
    public ParkingMeterData putDataIntoMeter(int meterNumber){
        ...
        switch (meterNumber){
            case 0: pmd.setId(111111);  //My address
                ...
                pmd.setAddress("205 S Franklin Dr, 36081, Troy, Alabama");
                break;
            case 1: pmd.setId(111112);  //University Avenue
                ...
                pmd.setAddress("205 S Franklin Dr, 36081, Troy, Alabama");  //TODO: update address
                break;
            case 2: pmd.setId(111113);  //Walmart
                ...
                pmd.setAddress("1420 Highway 231 S, 36081, Troy, Alabama");
                break;
            ...
            case 4: pmd.setId(111115);  //Troy Utilities Department
                pmd.setAvailable(true);    //TODO: make sure this reflects the actual availability
                pmd.setTimeTillAvailble(0);
                pmd.setPrice(0.85);
                ...
                pmd.setAddress("306 E Academy St, 36081, Troy, Alabama");  //TODO update address
                break;
        }
        return pmd;
    }
    ...
    public void onInfoWindowClick(Marker marker) {
            ...
            intent.putExtra("availability" , marker.getTitle().substring(20));
